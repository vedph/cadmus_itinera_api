...
xcopy %src%cadmus.itinera.services\1.0.12\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.itinera.parts\1.0.7\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.seed.itinera.parts\1.0.11\*.nupkg .\local-packages\ /y
