...
xcopy %src%cadmus.api.services\1.0.11\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.api.controllers\1.0.8\*.nupkg .\local-packages\ /y

xcopy %src%cadmus.itinera.parts\1.0.8\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.seed.itinera.parts\1.0.13\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.itinera.services\1.0.14\*.nupkg .\local-packages\ /y
